...
CREATE TABLE IF NOT EXISTS guardrail_logs (
    ...
    INDEX idx_gl_agent_name (agent_name),
    INDEX idx_gl_guardrail_type (guardrail_type),
    INDEX idx_gl_action_taken (action_taken),
    INDEX idx_gl_timestamp (timestamp),
    INDEX idx_gl_user_id (user_id)
);
